...
GO
PRINT N'Creating [dbo].[Gebruikers]...';
...
CREATE TABLE [dbo].[Gebruikers] (
    ...
    CONSTRAINT [UK_Gebruikers] UNIQUE NONCLUSTERED ([VoorNaam] ASC, [AchterNaam] ASC, [Adres] ASC, [ZipCode] ASC)
);


GO
PRINT N'Creating [dbo].[Ingrediënten]...';
...
CREATE TABLE [dbo].[Ingrediënten] (
    ...
    CONSTRAINT [UK_Ingrediënten] UNIQUE NONCLUSTERED ([Ingrediënt] ASC)
);
...
CREATE TABLE [dbo].[Labels] (
    ...
    CONSTRAINT [UK_Labels] UNIQUE NONCLUSTERED ([Label] ASC)
);


GO
PRINT N'Creating [dbo].[Maaltijden]...';
...
CREATE TABLE [dbo].[Maaltijden] (
    ...
    CONSTRAINT [UK_Maaltijden] UNIQUE NONCLUSTERED ([Maaltijd] ASC)
);


GO
PRINT N'Creating [dbo].[Recepten]...';
...
CREATE TABLE [dbo].[Recepten] (
    ...
    CONSTRAINT [UK_Recepten] UNIQUE NONCLUSTERED ([ReceptNaam] ASC, [GebruikersId] ASC)
);


GO
PRINT N'Creating [dbo].[ReceptIngrediënt]...';
...
GO
PRINT N'Creating [dbo].[ReceptLabel]...';
...
GO
PRINT N'Creating [dbo].[ReceptMaaltijd]...';
...
CREATE TABLE [dbo].[Reviews] (
    ...
    CONSTRAINT [UK_Reviews] UNIQUE NONCLUSTERED ([Review] ASC, [ReceptId] ASC, [GebruikersId] ASC)
);
...
CREATE TABLE [dbo].[ZipCodes] (
    ...
    CONSTRAINT [UK_ZipCodes] UNIQUE NONCLUSTERED ([Stad] ASC)
);


GO
PRINT N'Creating [dbo].[FK_GebruikersZipCode]...';


GO
ALTER TABLE [dbo].[Gebruikers] WITH NOCHECK
    ADD CONSTRAINT [FK_GebruikersZipCode] FOREIGN KEY ([ZipCode]) REFERENCES [dbo].[ZipCodes] ([ZipCode]);


GO
PRINT N'Creating [dbo].[FK_ReceptenGebruikersId]...';


GO
ALTER TABLE [dbo].[Recepten] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptenGebruikersId] FOREIGN KEY ([GebruikersId]) REFERENCES [dbo].[Gebruikers] ([GebruikersId]);


GO
PRINT N'Creating [dbo].[FK_ReceptIngrediëntReceptId]...';


GO
ALTER TABLE [dbo].[ReceptIngrediënt] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptIngrediëntReceptId] FOREIGN KEY ([ReceptId]) REFERENCES [dbo].[Recepten] ([ReceptId]);


GO
PRINT N'Creating [dbo].[FK_ReceptIngrediëntIngrediëntId]...';


GO
ALTER TABLE [dbo].[ReceptIngrediënt] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptIngrediëntIngrediëntId] FOREIGN KEY ([IngrediëntId]) REFERENCES [dbo].[Ingrediënten] ([IngrediëntId]);


GO
PRINT N'Creating [dbo].[FK_ReceptLabelReceptId]...';


GO
ALTER TABLE [dbo].[ReceptLabel] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptLabelReceptId] FOREIGN KEY ([ReceptId]) REFERENCES [dbo].[Recepten] ([ReceptId]);


GO
PRINT N'Creating [dbo].[FK_ReceptLabelLabelId]...';


GO
ALTER TABLE [dbo].[ReceptLabel] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptLabelLabelId] FOREIGN KEY ([LabelId]) REFERENCES [dbo].[Labels] ([LabelId]);


GO
PRINT N'Creating [dbo].[FK_ReceptMaaltijdReceptId]...';


GO
ALTER TABLE [dbo].[ReceptMaaltijd] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptMaaltijdReceptId] FOREIGN KEY ([ReceptId]) REFERENCES [dbo].[Recepten] ([ReceptId]);


GO
PRINT N'Creating [dbo].[FK_ReceptMaaltijdMaaltijdId]...';


GO
ALTER TABLE [dbo].[ReceptMaaltijd] WITH NOCHECK
    ADD CONSTRAINT [FK_ReceptMaaltijdMaaltijdId] FOREIGN KEY ([MaaltijdId]) REFERENCES [dbo].[Maaltijden] ([MaaltijdId]);


GO
PRINT N'Creating [dbo].[FK_ReviewsReceptId]...';


GO
ALTER TABLE [dbo].[Reviews] WITH NOCHECK
    ADD CONSTRAINT [FK_ReviewsReceptId] FOREIGN KEY ([ReceptId]) REFERENCES [dbo].[Recepten] ([ReceptId]);


GO
PRINT N'Creating [dbo].[FK_ReviewsGebruikersId]...';


GO
ALTER TABLE [dbo].[Reviews] WITH NOCHECK
    ADD CONSTRAINT [FK_ReviewsGebruikersId] FOREIGN KEY ([GebruikersId]) REFERENCES [dbo].[Gebruikers] ([GebruikersId]);


GO
PRINT N'Creating [dbo].[Grieks]...';
...
CREATE VIEW Grieks
	...
	WHERE Label = 'Grieks'
GO
PRINT N'Creating [dbo].[NieuweGebruiker]...';
...
GO
ALTER TABLE [dbo].[Gebruikers] WITH CHECK CHECK CONSTRAINT [FK_GebruikersZipCode];

ALTER TABLE [dbo].[Recepten] WITH CHECK CHECK CONSTRAINT [FK_ReceptenGebruikersId];

ALTER TABLE [dbo].[ReceptIngrediënt] WITH CHECK CHECK CONSTRAINT [FK_ReceptIngrediëntReceptId];

ALTER TABLE [dbo].[ReceptIngrediënt] WITH CHECK CHECK CONSTRAINT [FK_ReceptIngrediëntIngrediëntId];

ALTER TABLE [dbo].[ReceptLabel] WITH CHECK CHECK CONSTRAINT [FK_ReceptLabelReceptId];

ALTER TABLE [dbo].[ReceptLabel] WITH CHECK CHECK CONSTRAINT [FK_ReceptLabelLabelId];

ALTER TABLE [dbo].[ReceptMaaltijd] WITH CHECK CHECK CONSTRAINT [FK_ReceptMaaltijdReceptId];

ALTER TABLE [dbo].[ReceptMaaltijd] WITH CHECK CHECK CONSTRAINT [FK_ReceptMaaltijdMaaltijdId];

ALTER TABLE [dbo].[Reviews] WITH CHECK CHECK CONSTRAINT [FK_ReviewsReceptId];

ALTER TABLE [dbo].[Reviews] WITH CHECK CHECK CONSTRAINT [FK_ReviewsGebruikersId];
